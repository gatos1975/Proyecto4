...
var guardaryeditar = (e) => {
  e.preventDefault();
  var formData = new FormData($("#form_alumnos")[0]);
  var cod_alumnos = document.getElementById("cod_alumnos").value;
  console.log(cod_alumnos);
  if (cod_alumnos > 0) {
    var alumnos = new Alumnos_Model("","","","","","","","","",formData,"editar")
    alumnos.editar();
  } else {
...
var editar = (cod_alumnos) => {
  var uno = new Alumnos_Model(
    cod_alumnos,
    "",
    "",
    "",
...
var eliminar = (cod_alumnos) => {
  var eliminar = new Alumnos_Model(
    cod_alumnos,
    "",
    "",
    "",
